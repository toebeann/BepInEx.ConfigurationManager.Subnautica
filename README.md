## Plugin / mod configuration manager for BepInEx 5, tweaked for use in Subnautica
...
-   [Download the latest release from the Releases page](/toebeann/BepInEx.ConfigurationManager.Subnautica/releases/latest).
